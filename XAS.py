...
class _MDAdatafile():
        ...
        def __init__(self, filename, header_lines=0, flavour="IDC4"):
                ...
                header_lines: How many lines of the file needs to be skipped before the data starts (titles will therefore be self.header_lines-1).
                flavour: Just a way of identifying how the data should be extracted depending on which facility it was collected at."""
